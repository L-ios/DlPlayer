...
public class DragController {
    ...
    static {
        mPaint.setColorFilter(BubbleTextView.HIDESEAT_ICON_FADING_FILTER);
    }
    ...
    public void startDrag(Bitmap b, int dragLayerX, int dragLayerY,
        ...
        if (dragInfo instanceof ItemInfo &&
            ...
            dragView.setLayerType(View.LAYER_TYPE_HARDWARE, mPaint );
        }
    ...
    private boolean isSupportFlingToMove(DragObject d) {
        return d != null && (d.dragInfo instanceof ShortcutInfo || d.dragInfo instanceof FolderInfo)
