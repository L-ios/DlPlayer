    ...
    class MyAdapter extends BaseAdapter implements AdapterView.OnItemClickListener {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if(viewList.get(position) != null) {
                ...
                view.applyFromShortcutInfo(shortcut);
                //gridview will distribute the empty by the width and height of the view
                view.setWidth(BubbleTextView.getBUBBLE_WIDTH());
                view.setHeight(BubbleTextView.getBUBBLE_HEIGHT());
                app.setTag(shortcut);
                // if do not set the layoutParams,the gridview will calculate it
                // dynamically
                app.setLayoutParams(new FrameLayout.LayoutParams(BubbleTextView
                        .getBUBBLE_WIDTH() + offSet * 2, BubbleTextView
                        .getBUBBLE_HEIGHT() + offSet * 2));
