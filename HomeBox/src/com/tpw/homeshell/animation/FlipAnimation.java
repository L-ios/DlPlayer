package com.tpw.homeshell.animation;


import java.util.ArrayList;

//import tpw.util.ImageUtils;
...
import com.tpw.homeshell.FolderUtils;
import com.tpw.homeshell.Launcher;
import com.tpw.homeshell.LauncherAnimUtils;
...
public class FlipAnimation extends BroadcastReceiver{
    ...
    public final static String CLOSE_ACTION = "com.tpw.homeshell.CLOSE_CARD";
    ...
    private AnimatorListener mStartStageOfSmallAnimatorListener = new AnimatorListener() {
        ...
        public void onAnimationEnd(Animator animation) {
            ...
            if (mBlurTask == null)
                (mBlurTask = new BlurTask(mBackground)).execute();
            startStageOfBig();
        }
