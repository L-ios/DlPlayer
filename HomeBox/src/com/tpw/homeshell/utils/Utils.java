...
public class Utils {
    ...
    private static final String SEARCH_PACKAGE_NAME = "com.yunos.alimobilesearch";
    private static  Intent mSearchIntent = new Intent("android.intent.action.ALISEARCH");
//    
...
//    public static final String PREFERENCES_FILE = "/data/data/com.tpw.homeshell/shared_prefs/";
...
//
//    public final static String ACTION_WIDGET_ADDED = "com.tpw.homeshell.action.ADD_WIDGET";
...
//
    ...
    public static boolean isForCMCC() {
        String PERSIST_ENV_SPEC = "persist.env.spec";
        String CHINA_MOBILE = "ChinaMobile";
        String spec = ACA.SystemProperties.get(PERSIST_ENV_SPEC);
...
//    }
	...
	//HLog.e(TAG,"ro.yunos.version"+ SystemProperties.get("ro.yunos.version"));
        return IS_YUNOS_2_9;
    }


    private static final boolean IS_YUNOS_2_9 = ACA.SystemProperties.get("ro.yunos.version").startsWith("2.9");


    public static boolean isYunOSInternational() {
        return "true".equals(IS_YUNOS_INTERNATIONAL);
    }
    ...
    private static final String IS_YUNOS_INTERNATIONAL = ACA.SystemProperties.get("ro.yunos.international");


    private static final boolean IS_LOW_RAM = "true".equals(ACA.SystemProperties.get("ro.config.low_ram", "false"));
    ...
    static public boolean isSupportAppStoreQuickControl(Context context){
        String pkgOfAppStore = "com.tpw.wireless.vos.appstore";
    ...
    public static boolean isSupportSearch(Context mContext) {
        ...
        try {
            ...
            if (pm != null) {
                try {
                    pm.getPackageInfo(SEARCH_PACKAGE_NAME,
                            PackageManager.GET_ACTIVITIES);
                    support = isIntentAvailable(mContext);
                } catch (NameNotFoundException e) {
                    support = false;
                    e.printStackTrace();
                }
            ...
            Log.e(TAG, "find search app error ", e);
        }
        return support;
    }

    public static boolean isIntentAvailable(Context mContext) {
        final PackageManager packageManager = mContext.getPackageManager();
        List<ResolveInfo> resolveInfo = packageManager.queryIntentActivities(
                mSearchIntent, PackageManager.MATCH_DEFAULT_ONLY);
