...
public final class Utilities {
    ...
    public static Intent getApkIntent(FileAndInfo fileAndInfo,Context context,PackageManager packageManager)
	 {
		 String pkgname=fileAndInfo.mPkgInfo.applicationInfo.packageName;
		 ...
		 if(isApkInstalled(pkgname,context))
		 {
			 //
			 Intent newIntent = new Intent();
			 try
			 {
				 newIntent =packageManager.getLaunchIntentForPackage(pkgname);
			 }catch(Exception e)
			 {
				 return noinstallIntent;
			 }
		     return newIntent;
		 }
		 else
    ...
    public static Intent getApkInent(String pkgName,Context context)
    {
    	 Intent newIntent = new Intent();
		 try
		 {
	 ...
	 public static boolean isApkInstalled(String pkgName,Context context)
	    {
	    	boolean isIn=false;
	    	ArrayList<String> al=getInstalledPkgName(context);
	        
	        for(int i=0;i<al.size();i++)
	        {
	        	if(al.get(i).equals(pkgName))
	        	{
	        		isIn=true;
	        		break;
	        	}
	 ...
	 public static ArrayList<String> getInstalledPkgName(Context context)
	    {
	 ...
	 public static final String SYS_TIMED_FLAG="persist.sys.timed.flag";
	 public static final String SYS_WAIT_TIME_OK="persist.sys.waittime.ok";
	//topwise zyf add for refreshhome
	public static final String ACTION_REFRESH_HOME="com.tpw.homerefresh";
	...
	//topwise zyf add end
	 public static final int INT_MAX_DAYS=15;
	 public static int diffTwoTimeDays(long time1,long time2)
		{
			return (int)((time1-time2)/(24*60*60*1000));
		}
		public static int diffTwoTimeDays(String strtime1,String strtime2)
		{
			try{
			...
			{
				Log.e(TAG, "diffTwoTime  NumberFormatException  error: "+ne);
				return 0;
			}
		}
		public static int diffTwoTimeDays(String strtime1,long time2)
		{
			try{
				long time1=Long.valueOf(strtime1);
				return (int)((time1-time2)/(24*60*60*1000));
		...
		public static int diffTwoTimeDays(long time1,String strtime2)
		{
			try{
				long time2=Long.valueOf(strtime2);
				return (int)((time1-time2)/(24*60*60*1000));
