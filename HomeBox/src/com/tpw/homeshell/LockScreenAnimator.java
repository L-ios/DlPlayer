...
public class LockScreenAnimator {
    ...
    private static final String tpw_KEYGUARD_LOCK_ACTION = "tpw.intent.action.KEYGUARD_LOCK";
    ...
    private boolean recordOriginAndGenerateAnimation(){
        ...
        mWorkspace.setIsPlayingUnlockAnimation(true);
    ...
    private void putIconsToOriginPosition(){
        for( int i = 0; i < recordViews.size(); i++ ){
            ...
            child.setAlpha(1);
            mCurCellLayout.addViewToCellLayout(child, i, child.getId(), params, true);
        }
    }
    ...
    public void restoreIfNeeded(){
        if( needed ){
            ...
            putIconsToOriginPosition();
            mWorkspace.setIsPlayingUnlockAnimation(false);
    ...
    class LockScreenAnimatorListener implements AnimatorListener{
        ...
        public void onAnimationEnd(Animator arg0) {
            if( mLauncher.hasWindowFocus() ){
                Intent intent = new Intent(tpw_KEYGUARD_LOCK_ACTION);
