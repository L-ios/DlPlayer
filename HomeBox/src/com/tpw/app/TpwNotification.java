...
/** 
 * @file      tpwNotification.java
 * This file include tpwNotification definition. 
 *
 *
...
public class TpwNotification
{
     ...
     * Phone package name
     */
    public final static String PACKAGE_NAME_PHONE = "com.android.phone";

    /**
     * Phone package name for Missed Call Notifier
     */
    public final static String PACKAGE_NAME_TELECOM = "com.android.server.telecom";
     ...
     */
    public final static String PACKAGE_NAME_AUDIO_RECORDER = "com.tpw.note";
	public final static String PACKAGE_NAME_BROWSER = "com.tpw.mobile.browser";
    ...
    public final static String ACTION_APPLICATION_NOTIFICATION 
        = "com.tpw.action.application.notification";
    /**
